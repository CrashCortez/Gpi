...
sudo wget https://raw.githubusercontent.com/CrashCortez/Gpi/master/runcommand-onend.sh
sudo wget https://raw.githubusercontent.com/CrashCortez/Gpi/master/runcommand-onstart.sh
sudo chmod a+x *.sh
cd
cd /opt/retropie/supplementary/xboxdrv/bin
sudo rm quit.sh
sudo wget https://raw.githubusercontent.com/CrashCortez/Gpi/master/quit.sh
